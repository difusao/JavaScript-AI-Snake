...
const model = { popTotal: 100, mutation: 0.10, best: 1, wmin: -0.1, wmax: 0.1 };
const ag = AGWB(model);
...
const update = function (timeStamp) {
  ...
  sensorFood = drawSensorFood({ draw: true, lineWidth: 1, strokeStyle: "#202020", lineDash: [] });
  ...
  info.update(
    { x: 10, y: 10, s: 100, sy: 30, title: "INFO", titleColor: '#00FF00', font: "Bold 12px arial", lineWidth: 1, lineColor: "#FFFFFF", lineDash: [] },
    {
      ...
      textColor: ['#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF', '#A0A0A0', '#A0A0A0', '#A0A0A0', '#A0A0A0', '#A0A0A0'],
      ...
      valueColor: ['#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF', '#FFFFFF', '#A0A0A0', '#A0A0A0', '#A0A0A0', '#A0A0A0', '#A0A0A0'],
    }
  );
...
const start = function () {
  ...
  */
  ...
  for (let i = 0; i < 255; i++)
    food.push({ x: Math.round(Math.random() * (renderScr.canvas.width - 50) / 10) * 10 + 20, y: Math.round(Math.random() * (renderScr.canvas.height - 50) / 10) * 10 + 20 });
